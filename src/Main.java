...
public class Main extends JFrame {
    ...
    private JButton btnRegistrar, btnCerrar; // Defino la variable para guardar el botón cerrar. FFFFF
    ...
    public Main() {
        ...
        setSize(500, 500); // Define el ancho y alto de la ventana.
        ...
        btnCerrar.addActionListener(e -> System.exit(0)); // Defino la acción al botón cerrar. FFFFF
